...
//        try {
//            HttpURLConnection connection = (HttpURLConnection) new URL("https://api.exchangeratesapi.io/latest?base="+spinner.getSelectedItem()+"&&symbols="+spinner2.getSelectedItem()).openConnection();
//            connection.setRequestMethod("GET");
//            connection.connect();
//            reader= new BufferedReader(new InputStreamReader(connection.getInputStream()));
//            StringBuilder buf=new StringBuilder();
//            String output = buf.toString();
//            procent= Integer.parseInt(output.substring(output.indexOf(spinner.getSelectedItem().toString())+2,output.indexOf("}")));
//
//        } catch (Exception ex) {}
    }
